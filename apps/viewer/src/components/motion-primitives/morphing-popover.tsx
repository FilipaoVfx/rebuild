/* motion-primitives (https://motion-primitives.com), copiado al proyecto como indica la librería. */
import {
  useState,
  useId,
  useRef,
      ...
      {context.isOpen && (
        <>
          <motion.div
            ...
            aria-modal='true'
            className={cn(
              'absolute overflow-hidden rounded-md border border-rule bg-card p-2 text-ink shadow-md',
              className
            )}
            initial='initial'
            animate='animate'
