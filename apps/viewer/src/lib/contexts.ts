...
export const CONTEXTS: ContextDef[] = [
  {
    ...
    sitesMode: 'neutral',
    categoricalLegend: [
      { label: 'Comuna', color: 'rgb(72 76 84)' },
      { label: 'Barrio', color: 'rgb(140 146 156)', dashed: true },
      { label: 'Río / quebrada', color: 'rgb(104 150 190)' },
      { label: 'Hito', color: 'rgb(23 24 27)' },
      { label: 'Equipamiento municipal', color: 'rgb(37 99 160)' },
      { label: 'Foto de campo', color: 'rgb(23 24 27)' },
      { label: 'Sitio (sin colorear)', color: 'rgb(72 80 94)' },
    ],
    missingNote:
