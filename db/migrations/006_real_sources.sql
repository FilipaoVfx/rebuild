...
CREATE TABLE rebuild_core.building_footprint (
...
CREATE INDEX building_footprint_geom_idx ON rebuild_core.building_footprint USING GIST (geometry);

COMMENT ON TABLE rebuild_core.building_footprint IS
