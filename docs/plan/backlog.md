...
| E0-6 | Registro de fuentes con licencia, atribución y permiso de redistribución | `FR-ING-01`, `FR-LIC-01` | S |
...
**Puerta E0:** CI verde con E0-4; contrato congelado y revisado; S1 con número documentado; OI-A1 y OI-A2 cerrados.
...
| E3-10 | Confianza por sitio con drivers explícitos | `FR-QUAL-01` | M |
| E3-11 | **Densidad de red peatonal por comuna** como driver de confianza | **R5** | M |
| E3-12 | Modos degradados definidos por capa: parada total / omisión con penalización / fallback | `FR-DEG-01..02` | M |
...
| E6-8 | Metadatos autocontenidos en todo export (procedencia, versiones, estado sintético, timestamp) | `FR-EXP-04`, CON-07 | M |
